...
func _on_player_fire(bullet_direction: Vector2, starting_position: Vector2, bullet_penetration_chance: float):
	var bullet_node = bullet_template.instantiate()
	bullet_node.init(bullet_direction, starting_position, bullet_penetration_chance);
